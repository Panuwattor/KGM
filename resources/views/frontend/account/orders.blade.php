...
<div class="container acc-wrap">
    <div class="acc-layout">
        ...
        <div>
            <h2 style="font-size:20px;font-weight:800;color:var(--kgm-green-800);margin-bottom:20px;"><i class="bi bi-receipt"></i> คำสั่งซื้อของฉัน</h2>
            @if($orders->isEmpty())
            <div class="acc-card" style="text-align:center;padding:64px 28px;">
                ...
                <p style="color:#aaa;margin-bottom:16px;">ยังไม่มีคำสั่งซื้อ</p>
                <a href="{{ route('shop') }}" class="btn btn-primary">เริ่มช็อปปิ้ง</a>
            </div>
            @else
            <div style="display:flex;flex-direction:column;gap:16px;">
                @foreach($orders as $order)
                <div class="acc-card" style="padding:20px 24px;">
