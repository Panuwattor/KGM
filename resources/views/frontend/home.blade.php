...
<section class="product-showcase-section">
    <div class="container">
        <div style="text-align:center;margin-bottom:24px;">
            <div class="section-title" style="font-size:clamp(20px,4vw,28px);font-weight:700;color:white;">โปรโมชั่นประจำเดือนนี้</div>
            <div class="section-divider" style="margin:10px auto 0;"></div>
        </div>
        ...
        <div style="text-align:center;margin-top:24px;">
            <a href="{{ route('promotions') }}" class="btn btn-warning"><i class="bi bi-grid-3x3-gap"></i> ดูสินค้าโปรโมชั่นทั้งหมด</a>
        </div>
    </div>
</section>
